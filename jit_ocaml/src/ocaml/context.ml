...
(* Common *)
external get_var_address_from_name: ctx -> string -> nativeint = "caml_get_var_address_from_name"
external get_var_address_from_position: ctx -> int -> nativeint  = "caml_get_var_address_from_position"
...
external get_var_type: ctx -> nativeint -> int = "caml_get_var_type"
external get_named_var_type: ctx -> string -> int = "caml_get_named_var_type"
external get_var_dimension: ctx -> nativeint -> int * int = "caml_get_var_dimension"
external get_named_var_dimension: ctx -> string -> int * int  ="caml_get_named_var_dimension"
external increase_val_ref: ctx -> nativeint -> bool = "caml_increase_val_ref"
external decrease_val_ref: ctx -> nativeint -> bool = "caml_decrease_val_ref"
...
external is_var_complex: ctx -> nativeint -> bool = "caml_is_var_complex"
external is_named_var_complex: ctx -> string -> bool = "caml_is_named_var_complex"
external is_var_matrix_type: ctx -> nativeint -> bool = "caml_is_var_matrix_type"
external is_named_var_matrix_type: ctx -> string -> bool = "caml_is_named_var_matrix_type"
external is_row_vector: ctx -> nativeint -> bool = "caml_is_row_vector"
external is_named_row_vector: ctx -> string -> bool = "caml_is_named_row_vector"
external is_column_vector: ctx -> nativeint -> bool = "caml_is_column_vector"
external is_named_column_vector: ctx -> string -> bool = "caml_is_named_column_vector"
external is_vector: ctx -> nativeint -> bool = "caml_is_vector"
external is_named_vector: ctx -> string -> bool = "caml_is_named_vector"
external is_scalar: ctx -> nativeint -> bool = "caml_is_scalar"
external is_named_scalar: ctx -> string -> bool = "caml_is_named_scalar"
external is_square_matrix: ctx -> nativeint -> bool = "caml_is_square_matrix"
external is_named_square_matrix: ctx -> string -> bool = "caml_is_named_square_matrix"
external is_empty_matrix: ctx -> nativeint -> bool = "caml_is_empty_matrix"
...
(* String *)
external is_string_type: ctx -> nativeint -> bool = "caml_is_string_type"
external is_named_string_type: ctx -> string -> bool = "caml_is_named_string_type"
external get_allocated_single_string: ctx -> nativeint -> string = "caml_get_allocated_single_string"
external get_allocated_named_single_string: ctx -> nativeint -> string = "caml_get_allocated_named_single_string"
...
external get_matrix_of_string: ctx -> nativeint -> string array = "caml_get_matrix_of_string"
...
(* Double *)
external is_double_type: ctx -> nativeint -> bool = "caml_is_double_type"
external is_named_double_type: ctx -> string -> bool = "caml_is_named_double_type"
external get_scalar_double: ctx -> nativeint -> float = "caml_get_scalar_double"
external get_named_scalar_double: ctx -> nativeint -> float = "caml_get_named_scalar_double"
external get_scalar_complex_double: ctx -> nativeint -> float * float = "caml_get_scalar_complex_double"
...
external get_matrix_of_double: ctx -> nativeint -> float array = "caml_get_matrix_of_double"
external get_named_matrix_of_double: ctx -> string -> float array = "caml_get_named_matrix_of_double"
external get_complex_matrix_of_double: ctx -> nativeint -> float array * float array = "caml_get_complex_matrix_of_double"
